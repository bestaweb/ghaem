        ...
        <div class="page-title-area">
            <div class="container">
                <div class="page-title-content">
                    <h2> درباره حوزه و مدرسه علمیه حضرت قائم (عج) چیذر </h2>
                </div>
            </div>
        </div>
        <!-- End Page Title Area -->
                ...
                <div class="row align-items-center">
                    <div class="col-lg-6 col-md-12">
                        <div class="about-content">
                            <h3> درباره حوزه و مدرسه علمیه حضرت قائم (عج) چیذر </h3>
        ...
        <section class="team-area pb-70 pt-70">
            <div class="container">
                <div class="section-title">
                    <h3>مسئولین و هیئت امنا حوزه و مدرسه علمیه حضرت قائم (عج)</h3>
                </div>
