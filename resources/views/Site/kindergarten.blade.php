    ...
    <div class="container my-4">
        ...
        <div class="row py-4">
            ...
            <div class="col-md-6 mb-4">
                <img src="{{asset('/site/img/publish-center.jpg')}}" class="img-fluid" alt="تصویر مهدکودک 1">
            </div>
            <div class="col-md-6 mb-4">
                <h3 class="text-center text-md-right pb-4">فضای آموزشی و پرورشی</h3>
        ...
        <div class="row py-8">
            ...
            <div class="col-md-6 mb-4 order-md-2">
                <img src="{{asset('/site/img/publish-center2.jpg')}}" class="img-fluid" alt="تصویر مهدکودک 2">
            </div>
            <div class="col-md-6 mb-4 order-md-1">
                <h3 class="text-center text-md-right pb-4">مراقبت اصولی و کلاس های تربیتی</h3>
                <p>
