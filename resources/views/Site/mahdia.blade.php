    ...
    <div class="container my-4">
        ...
        <div class="row py-4 align-items-center">
            ...
            <div class="col-md-6 mb-4">
                <img src="{{asset('/site/img/mahdia/mahdia1.jpg')}}" class="img-fluid" alt="تصویر مهدیا 1">
            </div>
            <div class="col-md-6 mb-4">
        ...
        <div class="row py-8 align-items-center">
            ...
            <div class="col-md-6 mb-4 order-md-2">
                <img src="{{asset('/site/img/mahdia/mahdia2.jpg')}}" class="img-fluid float-left" alt="تصویر قرض الحسنه 2" >
            </div>
