...
@section('main')
    ...
    <div class="container my-4 d-flex flex-column align-items-center">
        <span class="my-4 col-lg-10" style="text-align: justify">
...
در حال حاضر این مؤسسه علمیه دارای رشته‌های تفسیر و علوم قرآنی و مشاوره خانواده با رویکرد اسلامی در سطح سه و تفسیر تطبیقی در سطح 4 می‌باشد.
        ...
        <section class="d-flex flex-column col-lg-6">
            <h3 class="my-5 d-flex justify-content-center">
                مقاطع تحصیلی واحدها و دوره های آموزشی
            </h3>
            <a href="{{asset('/site/pdf/آشنایی با دوره های آموزشی.pdf')}}" class="default-btn my-3">آشنایی با نظام های آموزشی حوزه های علمیه خواهران</a>
            <a href="{{asset('/site/pdf/سطح3.pdf')}}" class="default-btn">معرفی رشته های سطح 3 حوزه های علمیه خواهران</a>
            <a href="{{asset('/site/pdf/سطح4.pdf')}}" class="default-btn my-3">معرفی رشته های سطح 4 حوزه های علمیه خواهران</a>
        ...
        <section class="d-flex flex-column col-lg-6">
            ...
            <a href="{{asset('/site/pdf/دفترچه سطح3.pdf')}}" class="default-btn">دفترچه راهنمای پذیرش سطح 3 حوزه های علمیه خواهران</a>
            <a href="{{asset('/site/pdf/دفترچه سطح4.pdf')}}" class="default-btn my-3">دفترچه راهنمای پذیرش سطح 4 حوزه های علمیه خواهران</a>
