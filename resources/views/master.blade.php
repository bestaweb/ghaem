...
<footer class="footer-area">
    ...
    <div class="container">
        ...
        <div class="copyright-area">
            <p><i class="bx bx-copyright"></i> تمام محتوای این وبسایت به حوزه و مدرسه علمیه حضرت قائم (عج) تعلق دارد. طراحی و توسعه توسط <a href="https://bestagroup.ir" target="_blank">Bestagroup</a></p>
        </div>
    </div>
</footer>
<!-- End footer Area -->
